      ...
      <Layout>
        <div className="min-h-screen flex items-center justify-center pt-32">
          <div className="flex flex-col items-center gap-4 text-slate-400">
            ...
            <p className="text-[10px] font-black uppercase tracking-[0.2em]">Cargando Artículo...</p>
          </div>
        </div>
      </Layout>
    );
      ...
      <Layout>
        <div className="min-h-screen flex items-center justify-center pt-32">
          <div className="text-center">
            <h1 className="text-4xl font-poppins font-black mb-4">404 - {language === 'es' ? 'No Encontrado' : 'Not Found'}</h1>
            <p className="text-slate-500 mb-8">{language === 'es' ? 'El artículo solicitado no existe.' : 'The requested article does not exist.'}</p>
            <Link href="/blog" className="px-8 py-4 bg-accent-blue text-white rounded-full font-black text-xs uppercase tracking-widest">{t.back}</Link>
          </div>
        </div>
      </Layout>
    );
