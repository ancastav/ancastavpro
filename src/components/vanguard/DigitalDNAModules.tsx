...
export const DigitalDNAModules: React.FC<DigitalDNAModulesProps> = ({ lang }) => {
  ...
  return (
    <section id="diagnostic-lab" className="py-24 px-6 bg-white relative overflow-hidden font-poppins">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="mb-16 flex flex-col md:flex-row md:items-center justify-between gap-6 border-b border-slate-100 pb-12 animate-reveal">
          <div>
            <div className="inline-block px-3 py-1 mb-4 border border-slate-200 bg-slate-50 rounded text-[9px] font-bold text-slate-400 font-mono">
              ● {t.badge}
            </div>
          ...
          <div className="text-slate-400 text-sm max-w-md md:text-right font-mono uppercase tracking-widest leading-relaxed">
